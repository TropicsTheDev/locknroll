<template>
  <main class="app__main">
    ...
    <section class="featured">
      <h2 class="featured__heading">Featured Event</h2>
      <main class="featured__body">
...
.featured__heading, .past-events__heading {
...
.featured__body, .past-events__body {
  /* Centering */
  display: flex;
  align-items: center;
  gap: var(--f-size-base);
...
.featured__content, .past-events__content {
...
.featured__content h3, .past-events__content h3 {
  /* Spacing between texts */
  margin-bottom: calc(var(--f-size-base) / 2);
}

.featured__img-wrapper, .past-events__img-wrapper {
  /* Setting limitations on image size */
  max-width: 640px;
}

.featured__img, .past-events__img {
  object-fit: contain;
}
